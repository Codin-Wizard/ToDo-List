...
export function newProjectUI() {
  ...
  createNewProjectButton.textContent = "Add Project";
  createNewProjectButton.id = "new-project";
  ...
  createNewProjectButton.addEventListener("click", () => {
    ...
    createNewProject.append(
      newProjectName,
      confirmProjectName,
      exitPopup(createNewProject)
    );
...
function viewDetails(todo) {
  ...
  viewDetailsButton.addEventListener("click", () => {
    ...
    details.textContent = `Todo: ${todo.title}, Description: ${
      todo.description
    }, ${todo.calcDueDate()}`;
...
export function updateProjectDisplay(project) {
  ...
  if (existingProject) {
    ...
    main.append(projectElement, newProjectUI());
  }
}
